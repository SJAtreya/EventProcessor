...
public class IgnitionListener implements UpdateListener{
	...
	public void update(EventBean[] ignition,EventBean[] empty) {
		// TODO Auto-generated method stub
				SpeedStream stream = (SpeedStream) ignition[0].getUnderlying();
				System.out.println("Battery Critical identified in stream :" + (stream));
				...
				buffer.append(",");
				buffer.append("Possible Breakdown");
				buffer.append(",");
				buffer.append("ignition - Not Working");
				buffer.append(",");
